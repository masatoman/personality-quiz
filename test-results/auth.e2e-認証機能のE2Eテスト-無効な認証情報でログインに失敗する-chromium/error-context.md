...
- Name: 認証機能のE2Eテスト >> 無効な認証情報でログインに失敗する
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/auth.e2e.test.ts:32:7
...
Call log:
  - waiting for locator('[aria-label="email-input"]')
    ...
    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/auth.e2e.test.ts:33:16
```
