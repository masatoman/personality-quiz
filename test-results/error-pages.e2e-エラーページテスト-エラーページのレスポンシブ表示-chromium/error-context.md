...
- Name: エラーページテスト >> エラーページのレスポンシブ表示
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:66:7
...
Locator: locator('.error-container')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.error-container')

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:84:36
```
