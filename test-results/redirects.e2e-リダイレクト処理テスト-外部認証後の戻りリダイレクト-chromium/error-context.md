...
- Name: リダイレクト処理テスト >> 外部認証後の戻りリダイレクト
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/redirects.e2e.test.ts:106:7
...
Expected string: "http://localhost:3000/quiz"
Received string: "http://localhost:3000/auth/google/callback?code=test-code"
Call log:
  - expect.toHaveURL with timeout 5000ms
  - waiting for locator(':root')
    9 × locator resolved to <html lang="ja" class="__variable_f470d0 __variable_d84a80">…</html>
      - unexpected value "http://localhost:3000/auth/google/callback?code=test-code"

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/redirects.e2e.test.ts:112:24
```
