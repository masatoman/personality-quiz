...
- Name: エラーページテスト >> 403エラーページの表示と内容確認
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:47:7
...
Locator: locator('h1:has-text("403")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1:has-text("403")')

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:53:54
```
