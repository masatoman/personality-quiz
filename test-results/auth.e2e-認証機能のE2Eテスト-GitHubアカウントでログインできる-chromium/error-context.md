...
- Name: 認証機能のE2Eテスト >> GitHubアカウントでログインできる
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/auth.e2e.test.ts:24:7
...
Call log:
  - waiting for locator('[aria-label="github-login-button"]')

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/auth.e2e.test.ts:25:16
```
