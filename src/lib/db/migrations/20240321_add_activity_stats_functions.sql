-- マイグレーション: アクティビティ統計関数の追加
-- 作成日: 2024-03-21

-- 既存の関数が存在する場合は削除
DROP FUNCTION IF EXISTS get_contributions_stats();
DROP FUNCTION IF EXISTS get_points_stats();
DROP FUNCTION IF EXISTS get_streak_stats();
...
VALUES ('20240321', 'add_activity_stats_functions', NOW()); 