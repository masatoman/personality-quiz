...
- Name: リダイレクト処理テスト >> ログイン済みユーザーのアクセス制御
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/redirects.e2e.test.ts:63:7
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/redirects.e2e.test.ts:82:26
```
