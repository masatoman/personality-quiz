...
- Name: テストUIページ >> フォームテスト
- Location: /Users/master/Local Sites/testcursor/tests/e2e/test-ui.test.ts:17:7
...
Call log:
  - waiting for locator('#email') to be visible
    ...
    at /Users/master/Local Sites/testcursor/tests/e2e/test-ui.test.ts:19:44
```
