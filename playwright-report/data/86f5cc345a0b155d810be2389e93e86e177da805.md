...
- Name: リダイレクト処理テスト >> ログイン後の元ページへのリダイレクト
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/redirects.e2e.test.ts:45:7
...
Expected string: "http://localhost:3000/login?redirect=/dashboard"
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/redirects.e2e.test.ts:51:24
```
