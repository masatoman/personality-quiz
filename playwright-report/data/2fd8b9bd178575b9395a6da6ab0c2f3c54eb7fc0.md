...
- Name: 認証機能のE2Eテスト >> ログアウトができる
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/auth.e2e.test.ts:40:7
...
Call log:
  - waiting for locator('[aria-label="email-input"]')
    ...
    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/auth.e2e.test.ts:42:16
```
