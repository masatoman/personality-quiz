...
Call log:
  ...
  - waiting for locator(':root')
    9 × locator resolved to <html lang="ja" class="__variable_f470d0 __variable_d84a80">…</html>
      - unexpected value "http://localhost:3000/settings"

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/page-navigation.e2e.test.ts:69:28
```
