...
- Name: エラーページテスト >> エラーページのアクセシビリティ
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:97:7
...
Locator: locator('a[role="navigation"]')
Expected pattern: /.*へ移動/
Received: <element(s) not found>
Call log:
  - expect.toHaveAttribute with timeout 5000ms
  - waiting for locator('a[role="navigation"]')

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:111:35
```
