...
- Name: エラーページテスト >> 404エラーページの表示と内容確認
- Location: /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:13:7
...
Locator: locator('a:has-text("ホームへ戻る")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('a:has-text("ホームへ戻る")')

    at /Volumes/Samsung/Works/personality-quiz/tests/e2e/error-pages.e2e.test.ts:24:28
```
